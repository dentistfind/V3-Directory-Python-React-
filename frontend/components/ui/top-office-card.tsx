    ...
    return (
        <div className="border-b border-gray-300 p-5">
            <div className="md:flex gap-10">
                ...
                <div className="md:w-1/2 text-xs flex flex-col justify-between md:pt-20 pb-5">
                    ...
                    <div className="mt-5 md:mt-0 w-full text-center" onClick={handleOpenModal}><Button fill text="Send Appointment Request"/></div>
                </div>
            </div>
