...
export default function ReviewCard({ review: { author, content, createdAt, likeCount } }:{ review: ReviewData}){
    ...
    return(
        <div className="bg-gray-50 p-5 shadow rounded-md text-start text-xs h-50">
            <div className="">
