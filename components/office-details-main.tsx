...
export default function OfficeDetailsMain({ officeData }: { officeData: OfficeData}){
    const { name, address, website, mobileNumber, email, galleryMedia } = officeData
    ...
    return(
        <div className="bg-white px-10 py-10 text-black">
            <div className="flex flex-col lg:flex-row gap-10 pb-5 border-b border-gray-200">
                {/* Gallery */}
            ...
            <div className="py-10 space-y-5">
                ...
                <div className="flex items-center gap-5">
                    ...
                    <div className="text-sm">
                        <h3>{name}</h3>
                        <div>{address}</div>
                        {mobileNumber && <div><FaPhone />{mobileNumber}</div>}
                        {email && <div>{email}</div>}
                        {website && (
